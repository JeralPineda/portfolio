...
export const HeroSection = ({ lightText, imgStart, topLine, headLine, darkText, description, buttonLabel, img, alt, primary, dark, dark2, wallpaper, id }) => {
   const handleClick = () => {
      window.open('mailto:jeral.cris@gmail.com');
   };

   return (
      <HeroContainer wallpaper={wallpaper} id={id}>
         <HeroWrapper>
